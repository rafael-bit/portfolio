...
export const about = {
  ...
  highlight:
    'Entre os principais resultados da minha carreira estão a participação na evolução de uma plataforma com mais de 14 mil usuários e 20 mil eventos criados, o desenvolvimento de soluções utilizadas por mais de 130 municípios e a construção de sistemas de monitoramento e controle operacional para uma frota com mais de 500 veículos.',
  portrait: {
